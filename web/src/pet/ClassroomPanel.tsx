...
export default function ClassroomPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    ...
    >
      <div
        className="w-full max-w-lg rounded-chunk-xl border-[var(--outline-chunk-thick)] border-quest-ink/15 bg-quest-paper p-6 shadow-chunk-lg"
      ...
      >
        ...
        <input
          ...
          maxLength={40}
          className="mb-4 w-full rounded-chunk-sm border-[var(--outline-chunk)] border-quest-ink/25 bg-white px-3 py-2 font-medium text-quest-ink"
        />
        ...
        <div className="flex gap-2">
          <input
            ...
            maxLength={40}
            className="min-w-0 flex-1 rounded-chunk-sm border-[var(--outline-chunk)] border-quest-ink/25 bg-white px-3 py-2 font-medium text-quest-ink"
          />
